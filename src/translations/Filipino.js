...
export const FILIPINO_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'Gusto ko ipadala ang SAFE na ito.',
    ...
    notEnoughSAFE: 'Hindi sapat na kumpirmadong SAFE sa account para gawin ang transaksiyon.',
