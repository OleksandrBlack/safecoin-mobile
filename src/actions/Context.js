...
export const SET_SAFE_IN_BTC_VALUE = 'SET_SAFE_IN_BTC_VALUE'
export const SET_SAFE_IN_CURRENCY_VALUE = 'SET_SAFE_IN_CURRENCY_VALUE'

export function setSafeInBtcValue (BTCValue) {
  return {
    type: SET_SAFE_IN_BTC_VALUE,
    BTCValue
  }
}

export function setSafeInCurrencyValue (currencyValue) {
  return {
    type: SET_SAFE_IN_CURRENCY_VALUE,
    currencyValue
  }
}
